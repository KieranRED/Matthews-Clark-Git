export const metadata = {
  ...
  description: 'Matthews & Clark applies 1.5-yr to 5-yr ceramic coatings in Cape Town as part of detailing packages. Gold / Platinum / Diamond tiers.',
};
    ...
    <>
      ...
      <section className="svc-intro">
        <div className="container">
          ...
          <p>Matthews &amp; Clark applies ceramic coating in Cape Town as part of detailing packages. Ceramic coating is a liquid polymer that bonds chemically to vehicle paintwork, creating a semi-permanent protective layer that is hydrophobic, UV-resistant, and easier to maintain than bare paint. Coating durability ranges from 1.5 years to 5 years depending on the package selected.</p>
        </div>
      </section>
      ...
      <section className="svc-explainer">
        <div className="container">
          <div className="copy">
            ...
            <p>Most ceramics here are layered after <a href="/correction" style={{color:'var(--accent)'}}>paint correction</a> so we lock in a perfect finish, not the swirls underneath. Pair with <a href="/ppf" style={{color:'var(--accent)'}}>PPF</a> if you want both hydrophobics and chip protection.</p>
      ...
      <section className="final-cta" id="book">
        ...
        <p className="sub">Tell us the car and we&apos;ll talk you through the right tier — no upselling, no nonsense.</p>
