export const metadata = {
  ...
  description: 'Matthews & Clark offers 1-step and 2-step paint correction in Cape Town. Swirl, scratch and oxidation removal via machine polishing.',
};
    ...
    <>
      ...
      <section className="svc-intro">
        <div className="container">
          ...
          <p>Matthews &amp; Clark offers paint correction in Cape Town across two stages depending on the level of defects present. Paint correction is the process of removing surface defects from vehicle paintwork using machine polishing. Swirl marks, light scratches, water spots, and oxidation are removed by cutting and refining the clear coat. All results are inspected under high-intensity lighting before handover.</p>
        </div>
      </section>
      ...
      <section className="svc-explainer">
        <div className="container">
          <div className="copy">
            ...
            <p>It&apos;s not a quick fix. A 2-step correction on a German saloon takes two full days. But the result looks like the car just came off the transporter. Most clients then lock it in with <a href="/ceramic" style={{color:'var(--accent)'}}>ceramic coating</a> or <a href="/ppf" style={{color:'var(--accent)'}}>PPF</a> so they don&apos;t have to do it again.</p>
      ...
      <section className="svc-process" id="process">
        <div className="container">
          ...
          <div className="proc-grid">
            <div className="proc-step"><span className="num">01</span><h4>Paint inspection</h4><p>Under high-intensity lighting. We map what&apos;s there before we touch it.</p></div>
            ...
            <div className="proc-step"><span className="num">04</span><h4>Final inspection</h4><p>Back under the lights. If it&apos;s not right, we go again.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta" id="book">
        ...
        <p className="sub">Send us the car. We&apos;ll tell you straight what&apos;s correctable and what isn&apos;t.</p>
