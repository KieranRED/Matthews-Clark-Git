      ...
      <div style={{ position: "fixed", left: -10000, top: 0, width: 794, zIndex: -1 }}>
        <div className="preview" ref={previewRef} style={{ width: 794, padding: "40px 44px 56px" }}>
          <div className="inv-masthead">
            <div className="inv-from">
              ...
              <div className="inv-from-meta">
                ...
                <div className="inv-from-line">3 Muir St · District 6 · Woodstock · Cape Town 8001</div>
                <div className="inv-from-line">studio@matthewsclark.co.za · +27 21 555 0100</div>
              </div>
            </div>
          ...
          <div className="inv-partner">
            <div className="inv-eyebrow">WORKSHOP PARTNER</div>
            <div className="inv-partner-row">
              <img
                src="/brand/izimoto-logo.png"
                alt="Izi'Moto Auto Boutique"
                className="inv-izi-logo"
                crossOrigin="anonymous"
                style={{ height: 40, width: "auto", objectFit: "contain", display: "block" }}
              />
              <div className="inv-partner-meta">
                All work installed and warrantied by <b>Izi&apos;Moto Auto Boutique</b>
                <br />
                38 North Rand Rd · Boksburg · Johannesburg 1469
                <br />
                Authorised installer · ceramic, PPF, paint, wrap
              </div>
            </div>
          </div>
