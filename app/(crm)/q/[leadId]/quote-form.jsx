...
const SERVICE_META = {
  ...
  pc_street_gloss: { icon: "◍", label: "Paint Correction - Street Gloss", color: "#F2C94C" },
  pc_bronze: { icon: "◍", label: "Paint Correction - Bronze", color: "#C8825A" },
  pc_silver: { icon: "◍", label: "Paint Correction - Silver", color: "#C9CDD4" },
  pc_gold: { icon: "◍", label: "Paint Correction - Gold", color: "#D4AF37" },
  pc_diamond: { icon: "◍", label: "Paint Correction - Diamond", color: "#7FC7E8" },
