  ...
  return (
    <div className="screen">
      ...
      <div className="detail-hero">
        <span className="ph">[ hero photo placeholder · {v?.label || "Vehicle"} ]</span>
      ...
      {phone ? (
        <div style={{ padding: "0 18px 16px", display: "flex", gap: 8 }}>
          <a className="bigbtn bigbtn--p" href={`tel:${phone}`} style={{ flex: 1 }}>
      ...
      <div className="detail-section">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10, fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: ".14em", color: "var(--fg-3)", textTransform: "uppercase" }}>
          <span>Deposit · {moneyZAR(j.deposit || 0)}</span>
          <span style={{ color: j.balance > 0 ? "#F2C94C" : "#27AE60" }}>Balance · {moneyZAR(j.balance || 0)}</span>
          <span>Stage · {index?.stage(j.stage)?.label || j.stage}</span>
        </div>
      </div>
